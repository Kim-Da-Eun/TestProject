      ...
      <li class="nav-item">
       ...
       <div class="row">
           <div id="article-top" class="col-12 mb-3">
            <div id="carouselExampleIndicators" class="carousel slide col-12 mb-3" data-ride="carousel">
            ...
            <div class="row">
                ...
                <form class="form-inline">
                  ...
                  <button class="btn btn-outline-secondary m-auto col-2" type="submit">Search</button>
                </form>
                </div>
            </div>
           </div>
              ...
              <div class="row">
                   <div id="article-middle-left" class="col-6 text-center">
                    <div class="row">
                        ...
                        <div class="col-6"><a href="#">더보기</a></div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <a href="#">공지</a><br>
